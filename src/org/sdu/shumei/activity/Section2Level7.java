 ...
 * 
 */
public class Section2Level7 extends Section2BaseActivity {
	...
	protected void initLevelParameter() {
		this.mSection = 2;
		this.mLevel = 7;
		this.mNextLevelClass = Section2Level8.class;
		// 本关默认设置的树梅妹的个数
	...
	protected void addVillainToScene() {
		...
		final VillainShumei villain2 = VillainFactory.createVillainShumei(360,
				330, mVillainShumeiTexturePack, VillainPack.VILLAIN_SHUMEI2_ID,
				getVertexBufferObjectManager(), this,
				Const.VillainPoint.LEVEL1, Const.VillainLife.SHUMEI_LEVEL2,
				mVallainTransientTime);
		...
		// 第3个坏蛋
		final VillainShumei villain3 = VillainFactory.createVillainShumei(200,
				580, mVillainShumeiTexturePack, VillainPack.VILLAIN_SHUMEI3_ID,
				getVertexBufferObjectManager(), this,
				Const.VillainPoint.LEVEL1, Const.VillainLife.SHUMEI_LEVEL2,
				mVallainTransientTime);
		...
		// 第4个坏蛋
		final VillainShumei villain4 = VillainFactory.createVillainShumei(300,
	...
	protected void addSceneEntityToScene() {
		// 木板
		final Stick stick1 = SceneEntityFactory.createStick(60, 200,
		...
		final Stick stick2 = SceneEntityFactory.createStick(290, 200,
				mSceneEntityTexturePack, getVertexBufferObjectManager(), this);
		...
		// 旋转的树桩
		final Stump stump1 = SceneEntityFactory.createStump(240, 470,
				mSceneEntityTexturePack, getVertexBufferObjectManager(), this,
		...
		// 甲壳虫
		final Firebug bug1 = SceneEntityFactory.createFirebug(0, 560,
				mSceneEntityTexturePack, getVertexBufferObjectManager(), this);
		...
		final Firebug bug2 = SceneEntityFactory.createFirebug(470, 560,
				mSceneEntityTexturePack, getVertexBufferObjectManager(), this);
