 ...
 * 
 */
public class Section1Level4 extends Section1BaseActivity {
	...
	protected void initLevelParameter() {
		this.mSection = 1;
		this.mLevel = 4;
		this.mNextLevelClass = Section1Level5.class;
		// 本关默认设置的树梅妹的个数
	...
	protected void addVillainToScene() {
		// 第1个坏蛋
		final VillainShumei villain1 = VillainFactory.createVillainShumei(50,
				268, mVillainShumeiTexturePack, VillainPack.VILLAIN_SHUMEI1_ID,
		...
		// 第2个坏蛋
		final VillainShumei villain2 = VillainFactory.createVillainShumei(426,
				268, mVillainShumeiTexturePack, VillainPack.VILLAIN_SHUMEI1_ID,
				getVertexBufferObjectManager(), this,
				Const.VillainPoint.LEVEL1, Const.VillainLife.SHUMEI_LEVEL1,
				mVallainTransientTime);
		...
		final VillainShumei villain3 = VillainFactory.createVillainShumei(236,
				350, mVillainShumeiTexturePack, VillainPack.VILLAIN_SHUMEI1_ID,
				getVertexBufferObjectManager(), this,
				Const.VillainPoint.LEVEL1, Const.VillainLife.SHUMEI_LEVEL1,
				mVallainTransientTime);
		...
		final VillainShumei villain4 = VillainFactory.createVillainShumei(236,
				540, mVillainShumeiTexturePack, VillainPack.VILLAIN_SHUMEI1_ID,
				getVertexBufferObjectManager(), this,
				Const.VillainPoint.LEVEL1, Const.VillainLife.SHUMEI_LEVEL1,
				mVallainTransientTime);
	...
	protected void addSceneEntityToScene() {
		final Bulb bulb1 = SceneEntityFactory.createBulb(220, 268,
		...
		final Bulb bulb2 = SceneEntityFactory.createBulb(220, 460,
				mSceneEntityTexturePack, getVertexBufferObjectManager(), this,
