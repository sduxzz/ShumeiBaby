 ...
 * 
 */
public class Section1LevelChoice extends BaseActivity {
	...
	protected void onCreateResources() {
		...
		try {
			this.mTexturePack = new TexturePackLoader(getTextureManager(),
					...
					"section1_level_choice_pack.xml");
	...
	protected Scene onCreateScene() {
		...
		final Sprite background = new Sprite(0, 0,
				texturePackTextureRegionLibrary
						.get(Section1LevelChoicePack.BACKGROUND_1_ID),
	...
	private void addLevelButtonToScene() {
		...
		final ButtonSprite backBtn = new ButtonSprite(15, 28,
				texturePackTextureRegionLibrary
						.get(Section1LevelChoicePack.BUTTON_BACK1_NORMAL_ID),
				texturePackTextureRegionLibrary
						.get(Section1LevelChoicePack.BUTTON_BACK1_PRESSED_ID),
		...
		levelButtons = LevelButtonFactory.createSection1LevelButtons(
				mTexturePack, mLevelTextFont, getVertexBufferObjectManager(),
				this);
